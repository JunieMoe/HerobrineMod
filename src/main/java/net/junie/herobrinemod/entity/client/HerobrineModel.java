package net.junie.herobrinemod.entity.client;// Made with Blockbench 5.0.1
...
public class HerobrineModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(32, 0).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		.texOffs(32, 0).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
